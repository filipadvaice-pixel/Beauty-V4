...
const CONFIG = {
  ...
  webhook: "https://n8n-amstardam.tw1.su/webhook/b7598374-c25f-42ed-957c-06527e2e8616",
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <p className="text-white/70 mb-6">Расскажите голосом какие услуги вас интересуют и мы посчитаем примерную стоимость для вас</p>
